  ...
  <main>
    <section class="gallery-hero">
      <div>
        ...
        <h1>100 個可以獨立上線的旅行小工具。</h1>
        <p>每一個都是能開網址、能互動、能產生結果卡、能複製分享文案、能導回 ChillOut App 的小產品。行銷組可以拿單一工具做短影音、SEO、社群互動、創作者合作或廣告測試。</p>
        <div class="gallery-actions">
          <a class="product-button primary" href="tools/save-sprint.html">先玩第一個工具</a>
          <button class="product-button" type="button" data-random-tool>隨機抽一個</button>
          <a class="product-button" href="${appStoreUrl}?ct=tool_gallery_hero">下載 ChillOut</a>
        </div>
      </div>
      <div class="gallery-live-card">
        <img src="assets/tool-posters/save-sprint.svg" alt="IG 靈感急救室工具視覺">
      </div>
    </section>

    <section class="gallery-control-band">
      <div class="gallery-stat"><strong>100</strong><span>獨立工具頁</span></div>
      <div class="gallery-stat"><strong>10</strong><span>行銷主題系列</span></div>
      <div class="gallery-stat"><strong>100%</strong><span>導流 ChillOut</span></div>
